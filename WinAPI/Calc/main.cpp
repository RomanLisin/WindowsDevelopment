...
СONST INT g_i_INTERVAL = 5;		// расстояние между кнопками

СONST INT g_i_START_X = 10;		
СONST INT g_i_START_Y = 10;		
СONST INT g_i_BUTTON_START_X = g_i_START_X;		
СONST INT g_i_BUTTON_START_Y = g_i_START_X + g_i_SCREEN_HEIGHT + g_i_INTERVAL;		
